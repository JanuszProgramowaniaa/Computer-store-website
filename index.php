...
<body>
	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="img/oferta2.png">
				<div class="container">
					<div class="row">
						<div class="col-xl-6 col-lg-7 text-white">
							...
							<a href="https://www.intel.pl/content/www/pl/pl/products/processors/core/i9-processors.html" class="site-btn sb-line">Dowiedz się więcej</a>
			...
			<div class="hs-item set-bg" data-setbg="img/oferta1.png">
				<div class="container">
					<div class="row">
						<div class="col-xl-6 col-lg-7 text-white">
							<span>Technologia RTX</span>
							<h2>Karty graficzne</h2>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum sus-pendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </p>
							
							<a href="https://www.nvidia.com/pl-pl/geforce/20-series/rtx/" class="site-btn sb-white">Dowiedz się więcej</a>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-4 p-0 feature">
					<div class="feature-inner">
						...
						<h2>Szybkie bezpieczne zakupy</h2>
					</div>
				</div>
				<div class="col-md-4 p-0 feature">
					<div class="feature-inner">
		...
		<div class="container">
			...
			<div class="product-slider owl-carousel">
				<div class="product-item">
					<div class="pi-pic">
						<img src="./img/product/i7.png" alt="">
						<div class="pi-links">
								<a href="product.php?id=4" class="add-card"><i class="flaticon-bag"></i><span>Szczegóły</span></a>
				...
				<div class="product-item">
					<div class="pi-pic">
						...
						<img src="./img/product/Rtx2060.png" alt="">
						<div class="pi-links">
								<a href="product.php?id=6" class="add-card"><i class="flaticon-bag"></i><span>Szczegóły</span></a>
