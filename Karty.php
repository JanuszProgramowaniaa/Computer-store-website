		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0">
					...
					$result = mysqli_query($polaczenie,"select * from towary where typ='KartaGraficzna' ");
					$data= array();
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									...
									<div class="pi-links">
											<a  href="product.php?id= '  .$id .' " class="add-card"><i class="flaticon-bag"></i><span>Szczegóły</span></a>
