		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 contact-info">
					<h3>Napisz do nas teraz !!</h3>
					<p>Opole Prószkowska</p>
					<p>+734 867 934</p>
					<p>sklepkomputerowyx86@gmail.com</p>
					
					<form class="contact-form" name="email" action="Kontaktowy.php" >
						<input type="text" placeholder="Twoje imie" name="imie">
						<input type="text" placeholder="Twój e-mail" name="e-mail">
						<input type="text" placeholder="Temat" name="temat">
						<textarea placeholder="Wiadomosc" name="Wiadomosc"></textarea>
						<button class="site-btn" type="submit" >Wyślji teraz !!!</button>
					</form>
				</div>
			</div>
		</div>
		<div class="map"><iframe src="https://maps.google.com/maps?q=opole&t=&z=13&ie=UTF8&iwloc=&output=embed" style="border:0" allowfullscreen></iframe></div>
	</section>
